...
<head>
    <meta charset="UTF-8">
    <title>Manage Suppliers - Ayur-Smart</title>
    <style>
...
<body>
    ...
    <div class="tab-container">
        <a href="manage_users.php" class="tab-btn" style="background: rgba(255,255,255,0.1);">Manage Customers</a>
        <a href="manage_suppliers.php" class="tab-btn">Manage Suppliers</a>
    </div>

    <div class="table-container">
        <h2 style="text-align: left; color: #b7e4c7; margin-top: 0;">Supplier List</h2>
        <table>
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='3' style='text-align: center; padding: 20px;'>සපයන්නන් (Suppliers) නොමැත.</td></tr>";
                }
                ?>
            </tbody>
        </table>
